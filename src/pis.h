...
#define PIS_INSN(OPCODE, OPERAND_1, OPERAND_2) ((pis_insn_t){.opcode = (OPCODE), .operands = {(OPERAND_1), (OPERAND_2)}})
...
#define PIS_LIFT_RESULT_EMIT(LIFT_RESULT, INSN) CHECK_RETHROW(pis_lift_result_emit((LIFT_RESULT), &(INSN)))
