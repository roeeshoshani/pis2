...
#define _DECLARE_ARCH_SPECIFIC_SHELLCODE(ARCH, NAME)                                               \
    extern u8 __start_shellcode_emu_##NAME##_##ARCH[];                                             \
    extern u8 __end_shellcode_emu_##NAME##_##ARCH[];

#define _ARCH_SPECIFIC_SHELLCODE(ARCH, NAME)                                                       \
    {                                                                                              \
        .code = __start_shellcode_emu_##NAME##_##ARCH,                                             \
        .code_end = __end_shellcode_emu_##NAME##_##ARCH, .name = STRINGIFY(NAME##_##ARCH)          \
    }
