...
typedef enum {
    ...
    /// operand size is 16/32/64 bits
    /// default operand size is 32-bits
    OPCODE_ENCODING_NO_OPERANDS,

    /// instruction has no operands
    /// operand size is always 8-bits
    OPCODE_ENCODING_NO_OPERANDS_8,
...
const opcode_info_t first_byte_opcode_infos[256] = {
    ...
    // 0xa4
    {OPCODE_MNEMONIC_MOVS, OPCODE_ENCODING_NO_OPERANDS_8},
    // 0xa5
    {OPCODE_MNEMONIC_MOVS, OPCODE_ENCODING_NO_OPERANDS},
    // 0xa6
    {OPCODE_MNEMONIC_CMPS, OPCODE_ENCODING_NO_OPERANDS_8},
    // 0xa7
    ...
    // 0xaa
    {OPCODE_MNEMONIC_STOS, OPCODE_ENCODING_NO_OPERANDS_8},
    // 0xab
    {OPCODE_MNEMONIC_STOS, OPCODE_ENCODING_NO_OPERANDS},
    // 0xac
    {OPCODE_MNEMONIC_LODS, OPCODE_ENCODING_NO_OPERANDS_8},
    // 0xad
    {OPCODE_MNEMONIC_LODS, OPCODE_ENCODING_NO_OPERANDS},
    // 0xae
    {OPCODE_MNEMONIC_SCAS, OPCODE_ENCODING_NO_OPERANDS_8},
    // 0xaf
