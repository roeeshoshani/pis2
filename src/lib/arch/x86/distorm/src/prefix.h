...
_INLINE_ int __attribute__((unused)) prefixes_is_valid(unsigned char ch, _DecodeType dt)
{
...
_INLINE_ void __attribute__((unused)) prefixes_ignore(_PrefixState* ps, _PrefixIndexer pi)
{
	/*
